...
import PomTetsing.PomTesting.decoder.mycomponent.MyStreamDecoderImpl
import PomTetsing.PomTesting.manager.mycomponent.MyStreamManagerImpl
import PomTetsing.PomTesting.reader.mycomponent.MyStreamReaderImpl
import PomTetsing.PomTesting.transformer.mycomponent.MyStreamTransformerImpl
import PomTetsing.PomTesting.writer.mycomponent.MyStreamWriterImpl
